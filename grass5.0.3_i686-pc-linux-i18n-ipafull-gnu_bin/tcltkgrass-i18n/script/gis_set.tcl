#############################################################################
#
# $Id: gis_set.tcl,v 1.4 2001/03/02 08:48:39 justin Exp $
#
...
proc GetDir {entWidget locList mapList} \
{
    ...
    toplevel .getDir
    wm title .getDir [_ "New Database Directory"]
    ...
    button .getDir.buttonFrame.add -text [_ "OK"] \
    	-command \
	    "SetDatabase .getDir.base.list .getDir $entWidget $locList $mapList"
    button .getDir.buttonFrame.quit -text [_ "Cancel"] -command {destroy .getDir}
...
proc gisSetWindow {} {
    ...
    wm geometry . +100+100
    wm title . [_ "Grass 5.0 Data Selection"]
    ...
    .frame0.intro.msg insert end [_ "Welcome to GRASS GIS Version 5.0\n\n"]
    .frame0.intro.msg insert end [_ "Please select location and mapset\n"]
    .frame0.intro.msg insert end [_ "or define a new location\n"]
