...
proc mkColorPopup {w name {color "#000000"} {mode 0}} {
    ...
    frame $w.top.left
    Nv_mkColorScale $w.top.left [_ Red] $r red  $w.top.color
    Nv_mkColorScale $w.top.left [_ Green] $g green  $w.top.color
    Nv_mkColorScale $w.top.left [_ Blue] $b blue  $w.top.color
	...
	-text [_ Cancel]  -command "set CurrColor $tmp; destroy $w"
    label $w.bot.buttonframe.label -text [_ $name]
