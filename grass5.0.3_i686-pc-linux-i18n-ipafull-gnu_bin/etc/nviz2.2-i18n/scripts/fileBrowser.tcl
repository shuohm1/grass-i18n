...
#   set file_browser($w,start_dir) [exec pwd]
    ...
    label     $w.main.directories.label -text [_ DIRECTORIES]
    ...
    button $w.accept -text [_ Accept] -command "fileBrowser_accept_cmd $w"
    button $w.cancel -text [_ Cancel] -command "fileBrowser_cancel_cmd $w"
    
    frame $w.cur_directory
    label $w.cur_directory.label -text [_ "CURRENT:"]
